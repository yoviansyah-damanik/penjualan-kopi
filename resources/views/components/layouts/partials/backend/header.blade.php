    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/" wire:navigate class="flex ml-2 md:mr-24">
                    <img src="{{ Vite::image('logo.png') }}" class="h-8 mr-3" alt="Logo" />
                    <span
                ...
                <div class="flex items-center ml-3">
                    <div>
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full" src="{{ Auth::user()->image_path }}" alt="user photo">
                        </button>
                    </div>
                    {{-- Dropdown menu --}}
