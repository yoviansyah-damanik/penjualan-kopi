...
<body>
    <div class="box-bordered w-100">
        ...
        <p class="mt-3">
            Transaksi anda telah selesai. Kami telah melakukan pengiriman terhadap pesanan anda.
            Berikut data pengiriman:
        <div class="mb-0">
            <strong>{{ __('Delivery Code') }}:</strong>
        ...
        <div>
            <strong>{{ __('Estimated Arrival') }}:</strong>
            {{ $transaction->delivery->created_at->addDays($transaction->shipping->estimation_day)->translatedFormat('d M Y') }}
        </div>

        Anda dapat melacak pesanan anda melalui link di bawah ini.
        <div>
            <a href="https://tiki.id/id/track" target="_blank">https://tiki.id/id/track</a>
        </div>
        </p>
        <p class="mt-3">
            Terima Kasih telah membeli produk kami. Semoga anda puas dengan pelayanan dan produk kami.
            Kami tunggu pesanan anda selanjutnya. ^_^
        </p>
