<div>
    ...
    <h3 class="mb-6 dark:text-gray-400">
        {{ __('Are you sure you want to delete the :feature?', ['feature' => __('product')]) }}
    </h3>
    <button wire:click='delete_product' wire:loading.attr='disabled'
        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2.5 text-center mr-2 dark:focus:ring-red-900">
        {{ __('Yes, do it!') }}
    </button>
    <button type="button" data-drawer-dismiss="drawer-delete-product-default" wire:loading.attr='disabled'
