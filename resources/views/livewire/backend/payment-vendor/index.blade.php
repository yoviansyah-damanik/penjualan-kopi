<div>
        ...
        <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
            <div class="relative flex-none w-full mt-1 mb-3 lg:w-48 sm:w-64 xl:w-96">
                <input type="text" wire:change="resetPage" wire:model.live='search'
                    ...
                    placeholder="{{ __('Search for :search by :1 or :2', ['search' => __('payment vendors'), '1' => 'id', '2' => __('name')]) }}">
            ...
            <button id="createPaymentVendorButton"
                        ...
                        @forelse ($payment_vendors as $payment_vendor)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    @if ($payment_vendor->type == 'show')
                                        <button type="button" id="updatePayment VendorButton"
                                            wire:click="setItem('{{ $payment_vendor->slug }}','update')"
    ...
    <div id="drawer-update-payment-vendor-default" wire:ignore.self
    ...
    <div id="drawer-delete-payment-vendor-default" wire:ignore.self
        class="fixed top-0 right-0 z-40 w-full h-screen max-w-sm p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800"
        tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
        <h5 id="drawer-label"
    ...
    <div id="drawer-create-payment-vendor-default" wire:ignore.self
        class="fixed top-0 right-0 z-40 w-full h-screen max-w-sm p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800"
        tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
        <h5 id="drawer-label"
            class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">
...
@push('scripts')
    <script type="module">
        ...
        const $updateTargetEl = document.getElementById('drawer-update-payment-vendor-default')
        const $createTargetEl = document.getElementById('drawer-create-payment-vendor-default')
        const $destroyTargetEl = document.getElementById('drawer-delete-payment-vendor-default')
        ...
        const createInstanceOptions = {
            id: 'drawer-create-payment-vendor-default',
            override: true
        }

        const updateInstanceOptions = {
            id: 'drawer-update-payment-vendor-default',
            override: true
        }

        const destroyInstanceOptions = {
            id: 'drawer-destroy-payment-vendor-default',
            override: true
        }
        ...
        document.getElementById('createPaymentVendorButton').addEventListener('click', () => createDrawer.show())
    </script>
@endpush
