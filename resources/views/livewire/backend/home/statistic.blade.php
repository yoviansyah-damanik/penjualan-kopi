<div>
    <div class="mb-5 space-y-5">
        <div
            ...
            <div class="w-full">
                <h3 class="text-base font-normal text-gray-500 dark:text-gray-400">{{ __('Total Products') }}</h3>
        ...
        <div
            class="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            <div class="w-full">
                <h3 class="text-base font-normal text-gray-500 dark:text-gray-400">{{ __('Total Categories') }}</h3>
                <span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">
        ...
        <div
            class="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            <div class="w-full">
                <h3 class="text-base font-normal text-gray-500 dark:text-gray-400">{{ __('Total Payment Vendors') }}
                </h3>
                <span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">
    ...
    <div
        class="p-4 bg-white border border-gray-200 h-[580px] mb-5 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        ...
        <div id="fullWidthTabContent"
            class="border-t border-gray-200 dark:border-gray-600 h-full max-h-[400px] overflow-auto">
